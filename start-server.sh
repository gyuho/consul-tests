...
nohup consul agent -server -data-dir ${DATA_DIR} -http-port=8500 -advertise=127.0.0.1 -bind 0.0.0.0 -client 127.0.0.1 -bootstrap-expect 1 > ./consul-server.log 2>&1 &
